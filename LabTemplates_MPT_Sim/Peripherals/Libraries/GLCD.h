...
extern void GLCD_Simulation     (void);
...
extern void GLCD_WrCmd          (unsigned char );
extern void GLCD_WrDat          (unsigned short );
extern void GLCD_WrReg          (unsigned char reg, unsigned short val); 


#ifndef __TARGET_HW

#define GLCD_Init 					GLCD_S_Init
#define GLCD_Clear					GLCD_S_Clear
#define GLCD_SetBackColor		GLCD_S_SetBackColor
#define GLCD_DisplayString	GLCD_S_DisplayString
#define GLCD_SetBackColor		GLCD_S_SetBackColor
#define	GLCD_SetTextColor		GLCD_S_SetTextColor
#define	GLCD_DisplayChar		GLCD_S_DisplayChar
#define	GLCD_Simulation		  GLCD_S_Simulation
#define	GLCD_WrDat		      GLCD_S_WrDat
#define	GLCD_WrCmd		      GLCD_S_WrCmd
#define	GLCD_Bargraph		    GLCD_S_Bargraph
#endif
