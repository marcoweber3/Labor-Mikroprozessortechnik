//================================================================================
//SOURCE FILE GLCD_SPI_LPC1700.c:
//--------------------------------------------------------------------------------
//Datum: 08.06.2013
//--------------------------------------------------------------------------------
//Adaption durch: Manuel Jauss
//--------------------------------------------------------------------------------
//Copyright: Copyright (c)
//--------------------------------------------------------------------------------
//Adaptionen:    Urversion:
//Line   526:    LPC_GPIO4->FIOSET = 0x20000000;
//            -> Nach Initialisierung v. LCD/ Funktionsaufruf v. GLCD_Init():
//               Permanente Ausgabe v. '1' an Portpin P4.29
//               Resultierende Problematik:
//            -> Grüne LED (P4.29) v. RGB leuchtet permanent
//            -> Keine Deaktivierung v. grüner LED möglich

//               Adaptierte Version:
//Line   526:    Auskommentierung v. Programmzeile LPC_GPIO4->FIOSET = 0x20000000;
//            -> Keine Ausgabe v. '1' an Portpin P4.29
//               Eliminierung der Problematik:
//            -> Explizite Aktivierung und Deaktivierung v. grüner LED möglich
//--------------------------------------------------------------------------------
//Erweiterungen:
//Line 32 ff.  : -> Beschreibung der relevanten/ verwendeten Bibliotheksfunktionen
//--------------------------------------------------------------------------------
//Hinweise:      Funktionsprotoytpen/ Deklarationen v. Bibliotheksfunktionen
//            -> siehe Header File GLCD.h
//================================================================================
...
//ANMERKUNGEN:
//================================================================================
//LCD-Einheit: -> Beschreibung der relevanten/ verwendeten Bibliotheksfunktionen:
//================================================================================
//Bibliotheksfunktion GLCD_Clear():
//--------------------------------------------------------------------------------
//-> Implementierung v. Bibliotheksfkt.
//   siehe Line 903 ff.
...
//color:
//------
//= Farbe, mit welcher Diplay bereinigt werden soll


//--------------------------------------------------------------------------------
//Bibliotheksfunktion GLCD_SetBackColor():
//--------------------------------------------------------------------------------
//-> Implementierung v. Bibliotheksfkt.
//   siehe Line 891 ff.
...
//color:
//------
//= Hintergrundfarbe v. Characters u. Strings


//--------------------------------------------------------------------------------
//Bibliotheksfunktion LCD_SetTextColor():
//--------------------------------------------------------------------------------
//-> Implementierung v. Bibliotheksfkt.
//   siehe Line 879 ff.
...
//color:
//------
//= Vordergrund-/ Text-/ Zeichenfarbe


//--------------------------------------------------------------------------------
//Bibliotheksfunktion GLCD_DisplayString():
//--------------------------------------------------------------------------------
//-> Implementierung v. Bibliotheksfkt.
//   siehe Line 989 ff.
...
//1. unsigned int ln:
//-------------------
//= Line-/ Zeilennummer, in der String beginnen soll

//-> Bei ASCII Font 16x24/ ASCII Zeichensatz 16x24
//-> Breite v. jedem Character = 16 Pixel
//-> Höhe v. jedem Character = 24 Pixel

//Auflösung Display:
//= 320x240 Pixel
//-> Breite v. Display = 320 Pixel
//-> Höhe v. Display = 240 Pixel

//-> D.h. bei ASCII Zeichensatz 16x24 umfasst Display
//-> 320/16 = 20 Spalten
//-> 240/24 = 10 Zeilen

//Zur Info:
//Abmessungen v. Display:
//= 36,72x48,96 mmm
//-> D.h. Abmessung v. einem Pixel beträgt:
//-> 48,96 mm /320 Pixel = 0,153 mm
//   (bzw. 36,72 mm / 240 Pixel = 0,153 mm)

//-> D.h. Abmessung v. einem Character/ Zeichen bei ASCII Zeichensatz 16x24:
//Breite: 16 * 0,153 mm = 2,448 mm
//Höhe: 24 * 0,153 mm = 3,672 mm

//-> D.h. Abmessung v. einem Character/ Zeichen bei ASCII Zeichensatz 6x8:
//Breite: 6 * 0,153 mm = 0,918 mm
//Höhe: 8 * 0,153 mm = 1,224 mm

//Anzahl Zeilen u. Spalten bei ASCII Zeichensatz 6x8:
//-> 320/6 = 53,333 Spalten
//-> 240/8 = 30 Zeilen

//2. unsigned int col:
//--------------------
//= Column-/ Spaltennummer, in der String beginnen soll

//3. unsigned char fi:
//--------------------
//= Index für den zu verwendenden Zeichensatz/ Font
//-> 0 = ASCII Font 6x8/ ASCII Zeichensatz 6x8
//-> 1 = ASCII Font 16x24/ ASCII Zeichensatz 16x24
...
//--------------------------------------------------------------------------------
//Bibliotheksfunktion GLCD_DisplayChar():
//--------------------------------------------------------------------------------
//-> Implementierung v. Bibliotheksfkt.
//   siehe Line 966 ff.
...
//1. unsigned int ln:
//-------------------
//= Line-/ Zeilennummer, in der Character stehen soll

//2. unsigned int col:
//--------------------
//= Column-/ Spaltennummer, in der Character stehen soll
...
//-------------------
//ASCII Character
//-> siehe Header-Dateien Font_6x8_h.h und Font_6x8_h.h


//--------------------------------------------------------------------------------
//Bibliotheksfunktion GLCD_Bargraph():
//--------------------------------------------------------------------------------
//-> Implementierung v. Bibliotheksfkt.
//   siehe Line 1033 ff.
...
//1. unsigned int x:
//------------------
//Horizontale Startposition v. Balken in Pixel

//2. unsigned int y:
//------------------
//Vertikale Startposition v. Balken in Pixel
...
//5. unsigned int val:
//--------------------
//Aktive Balkenlänge in 1/1024-Schritten v. Maximallänge
//-> Auflösung v. Balkenlänge = 10-Bit
//================================================================================
...
/*******************************************************************************
* Write Data to the LCD controller                                        *
*   Parameter:      val:      data to write to the LCD                      *
*   Return:                                                                    *
*******************************************************************************/
 void GLCD_WrDat 					(unsigned short val){
	wr_dat (val);
}
